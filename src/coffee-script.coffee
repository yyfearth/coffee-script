...
exports.imports = imports = (code, options = {}) ->
  ...
  do parse = (code, filename) ->
    code.replace regex_g, (match) ->
      ...
      _filename = f + '.coffee' unless chk_file _filename
      _filename = f + '.iced' unless chk_file _filename
      _filename = f + '.js' unless chk_file _filename
      throw "In #{filename}, cannot find import: #{f}" unless chk_file _filename
      ...
      rmk = if /\.js$/.test filename then "/* imported #{_filename} */\n" else "### imported #{_filename} ###\n"
      rmk + parse import_code, _filename
...
exports.compile = compile = (code, options = {}) ->
  ...
  code = imports code, options if options.extra
  #console.log 'imported finished code:', code if options.extra
