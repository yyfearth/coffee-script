...
(function() {
  var Lexer, RESERVED, compile, fs, imports, lexer, minify, parser, path, vm, _ref,
  ...
  exports.minify = exports.min = minify;

  exports.compile = compile = function(code, options) {
    var header, js, lines, merge;
    if (options == null) options = {};
    if (options.min == null) options.min = options.minify || false;
    if (options.imports === true) options.imports = options;
    if (options.imports) code = imports(code, options.imports);
    ...
    if (options.min) js = minify(js, options.min);
    if (options.header) {
