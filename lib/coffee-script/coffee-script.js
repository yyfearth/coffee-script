...
(function() {
  var Lexer, compile, ext, extensions, fs, imports, lexer, loadFile, minify, parser, path, vm, _i, _len,
  ...
  exports.compile = compile = function(code, options) {
    var header, js, lines, merge, _ref;
    if (options == null) {
      options = {};
    }
    if ((_ref = options.min) == null) {
      options.min = options.minify || false;
    }
