(function() {
  var Lexer, compile, ext, extensions, fs, imports, lexer, loadFile, parser, path, vm, _i, _len,
  ...
  exports.compile = compile = function(code, options) {
    ...
    footer = "Generated by eXtraCoffeeScript " + this.VERSION;
    return "" + js + "\n// " + footer + "\n";
  };
