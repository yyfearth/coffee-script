...
(function() {
  var Lexer, SourceMap, child_process, compile, ext, fork, formatSourcePosition, fs, helpers, imports, lexer, loadFile, parser, patchStackTrace, patched, path, vm, _i, _len, _ref,
  ...
  exports.compile = compile = function(code, options) {
    var answer, currentColumn, currentLine, fragment, fragments, header, js, map, newLines, _i, _len;
    if (options == null) {
      options = {};
    }
