...
(function() {
  var Lexer, compile, ext, fs, helpers, imports, lexer, loadFile, parser, path, sourcemap, vm, _i, _len, _ref,
  ...
  exports.compile = compile = function(code, options) {
    var answer, coffeeFile, currentColumn, currentLine, fragment, fragments, header, js, jsFile, lines, merge, newLines, sourceMap, _j, _len1;
    if (options == null) {
      options = {};
    }
