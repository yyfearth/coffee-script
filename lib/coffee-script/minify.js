...
(function() {
  ...
  exports.minify = function(code, opt) {
    var ast, _ref1, _ref2, _ref3, _ref4;
    if (!opt || opt === true) {
      ...
      if ((_ref1 = opt.max_line_length) == null) {
        opt.max_line_length = (_ref2 = opt.max_line_len) != null ? _ref2 : 32768;
      }
      opt.lift_variables = opt.lift_variables || opt.lift_vars || false;
      if ((_ref3 = opt.ascii_only) == null) {
        opt.ascii_only = !opt.allow_non_ascii;
      }
      if ((_ref4 = opt.inline_script) == null) {
