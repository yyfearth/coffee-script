...
(function() {
  ...
  exports.Await = Await = (function(_super) {
    ...
    Await.prototype.transform = function(o) {
      var assign, assignments, body, call, cb_assignment, cb_lhs, cb_rhs, cls, fn_assignment, fn_lhs, fn_rhs, lhs, meth, n, name, rhs, trace, _ref3;
      body = this.body;
  ...
  exports.IcedRequire = IcedRequire = (function(_super) {
    ...
    function IcedRequire(args) {
      ...
      this.usage = "icedRequire takes one of {" + (types.join(',')) + "}";
    ...
    IcedRequire.prototype.compileNode = function(o) {
      var access, block, call, callv, file, fn, inc, k, lhs, ns, out, req, rhs, v, window_mode, window_val;
      this.tab = o.indent;
