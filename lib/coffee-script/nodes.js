...
(function() {
  ...
  exports.Block = Block = (function(_super) {
    ...
    Block.prototype.icedAddRuntime = function() {
      return this.expressions.unshift(new IcedRequire());
    };
  ...
  InlineRuntime = {
    generate: function(ns_window) {
      var a, a1, a2, a_copy, af, apply_call, args_literal, args_param, args_value, assignments, body, call_meth, cn, cnt, cnt_member, constructor_assign, constructor_body, constructor_code, constructor_name, constructor_params, decr, defer_assign, defer_body, defer_code, defer_name, defer_params, dp, dp_value, fields, fn_assign, fn_code, fn_name, for_assign, for_block, for_body, found_block, i, if_block, if_body, if_cond, if_expr, inc, inner_body, inner_code, inner_params, ip, k, k_literal, k_member, k_value, klass, klass_assign, my_apply, my_if, my_null, ns, ns_obj, ns_val, obj, outer_block, p1, ret_access, ret_access_inner, ret_assign, ret_literal, ret_member, ret_trace_assign, ret_value, rhs, unfound_block, _fulfill_assign, _fulfill_body, _fulfill_call, _fulfill_code, _fulfill_method, _fulfill_name;
      ...
      fields = (function() {
        var _i, _len, _ref3, _results;
        _ref3 = iced["const"].pass_fields;
        _results = [];
        for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
          i = _ref3[_i];
          _results.push(new Value(new Literal("'" + i + "'")));
        }
        return _results;
      })();
      ...
      for_block = new For(for_body, {
        name: k_value,
        source: new Arr(fields)
      });
