...
(function() {
  var Access, Arr, Assign, Await, Base, Block, Call, Class, Closure, Code, Comment, CpsCascade, Defer, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, InlineDeferral, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, NULL, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Slot, Splat, Switch, TAB, THIS, TameRequire, TameReturnValue, TameTailCall, Throw, Try, UTILITIES, Value, While, YES, compact, del, ends, extend, flatten, iced, last, merge, multident, starts, unfoldSoak, utility, _ref, _ref2,
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.compileCps = function(o) {
      ...
      if ((l = this.icedPrequels.length)) {
        k = this.icedContinuationBlock ? [this, this.icedContinuationBlock] : this.icedWrapContinuation() ? new TameTailCall(null, this) : this;
        while (l--) {
    ...
    Base.prototype.icedIsTamedExpr = function() {
  ...
  exports.Block = Block = (function(_super) {
    ...
    Block.prototype.icedAddRuntime = function() {
    ...
    Block.prototype.icedTransform = function() {
      ...
      if (obj.foundAwait) {
        if (obj.foundDefer && !obj.foundRequire) this.icedAddRuntime();
  ...
  exports.Literal = Literal = (function(_super) {
    ...
    Literal.prototype.compileNode = function(o) {
      var code, _ref3;
      code = this.isUndefined ? o.level >= LEVEL_ACCESS ? '(void 0)' : 'void 0' : this.value === 'this' ? ((_ref3 = o.scope.method) != null ? _ref3.bound : void 0) ? o.scope.method.context : this.value : this.value.reserved ? "\"" + this.value + "\"" : this.icedLoopFlag && this.icedIsJump() ? this.compileTame(o) : this.value;
      if (this.isStatement()) {
  ...
  exports.While = While = (function(_super) {
    ...
    While.prototype.icedCallContinuation = function() {
      return this.body.icedThreadReturn(new TameTailCall(iced["const"].n_while));
    };
  ...
  exports.TameRequire = TameRequire = (function(_super) {
    ...
    TameRequire.prototype.icedWalkAst = function(p, o) {
      this.icedHasAutocbFlag = o.foundAutocb;
      o.foundRequire = true;
      return TameRequire.__super__.icedWalkAst.call(this, p, o);
    };
  ...
  TameTailCall = (function(_super) {
    ...
    TameTailCall.prototype.icedCpsRotate = function() {
      var nv;
      if (this.value) {
        if ((nv = this.icedCpsExprRotate(this.value))) return this.value = nv;
      }
  ...
  TameReturnValue = (function(_super) {
    ...
    TameReturnValue.prototype.bindName = function(o) {
      var l;
      l = "" + (o.scope.freeVariable(iced["const"].param, false)) + "_" + (TameReturnValue.counter++);
