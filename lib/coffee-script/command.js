// Generated by eXtraCoffeeScript 1.2.0t
(function() {
  var BANNER, CoffeeScript, EventEmitter, SWITCHES, compileJoin, compileOptions, compilePath, compileScript, compileStdio, exec, forkNode, fs, handleIcedOptions, helpers, hidden, iced, joinTimeout, lint, loadRequires, min, notSources, optionParser, optparse, opts, outputPath, parseOptions, parser, path, printLine, printTokens, printWarn, removeSource, runtime_modes_str, sourceCode, sources, spawn, timeLog, uglify, unwatchDir, usage, version, wait, watch, watchDir, watchers, writeJs, _ref, _ref2,
  ...
  BANNER = 'Usage: xcoffee [options] path/to/script.coffee -- [args]\n\nIf called without options, `xcoffee` will run your script.';

  SWITCHES = [['-b', '--bare', 'compile without a top-level function wrapper'], ['-c', '--compile', 'compile to JavaScript and save as .js files'], ['--header', 'use a string as a head when compile is on'], ['-x', '--imports', 'enable import feature'], ['--min', 'enable uglify-js to minify compiled js'], ['--strict', 'enable runtime strict mode by add use strict into compiled js'], ['-e', '--eval', 'pass a string from the command line as input'], ['-h', '--help', 'display this help message'], ['-i', '--interactive', 'run an interactive CoffeeScript REPL'], ['-j', '--join [FILE]', 'concatenate the source CoffeeScript before compiling'], ['-l', '--lint', 'pipe the compiled JavaScript through JavaScript Lint'], ['-n', '--nodes', 'print out the parse tree that the parser produces'], ['--nodejs [ARGS]', 'pass options directly to the "node" binary'], ['-o', '--output [DIR]', 'set the output directory for compiled JavaScript'], ['-p', '--print', 'print out the compiled JavaScript'], ['-r', '--require [FILE*]', 'require a library before executing your script'], ['-s', '--stdio', 'listen for and compile scripts over stdio'], ['-t', '--tokens', 'print out the tokens that the lexer/rewriter produce'], ['-v', '--version', 'display the version number'], ['-w', '--watch', 'watch scripts for changes and rerun commands'], ['-I', '--runtime [WHICH]', "how to include the iced runtime, one of " + runtime_modes_str + "; default is 'node'"], ['-F', '--runforce', 'output an Iced runtime even if not needed']];
  ...
  loadRequires = function() {
    var realFilename, req, _i, _len, _ref3;
  ...
  parseOptions = function() {
    ...
    if (o.header != null) {
      if ((o.header != null) && !o.compile) throw 'use header only with compile';
